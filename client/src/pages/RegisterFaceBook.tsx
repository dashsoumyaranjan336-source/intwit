...
const RegisterFaceBook = () => {
  ...
  return (
    <Helmet title="Sign up • FaceBook • intwit">
          ...
          <div className="form-data-register">
            <form className=" absolute-center" onSubmit={formik.handleSubmit}>
              ...
              >
                ...
                information to intwit.
                <Link
                  to="https://www.facebook.com/help/intwit/261704639352628"
                  style={{ color: "#73b6fb" }}
                >
                  {" "}
                  Learn More
              ...
              >
                ...
                <Link
                  style={{ color: "#73b6fb" }}
                  to="https://help.intwit.com/581066165581870/?locale=en_US"
                >
                  Terms
                </Link>{" "}
                ...
                <Link
                  to="https://help.intwit.com/1896641480634370/"
                  style={{ color: "#73b6fb" }}
                >
                  Cookies Policy .
                </Link>
