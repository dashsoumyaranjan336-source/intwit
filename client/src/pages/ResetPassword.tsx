...
const ResetPassWord = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      // 🚨 FIX: Yahan await lagaya taaki pehle request complete ho
      await dispatch(
        resetPassword({
  ...
  // 🚨 ASLI FIX YAHAN HAI: Faltu ka navigate("") hata diya aur success par seedha /login bhej diya
  useEffect(() => {
  ...
  return (
    <Helmet title="Reset Password • intwit">
